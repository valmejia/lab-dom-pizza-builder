...
function renderPrice() {
  ...
  const cajitaDePrecio = document.querySelector('.panel.price ul')
 ...
 // calculo
  for(let i in state){
    if(state[i]){
      texto += `<li>$${ingredients[i].price} ${ingredients[i].name}</li>`
      suma += ingredients[i].price
    }}
    cajitaDePrecio.innerHTML = texto 
